...
<head>
    <meta charset="UTF-8">
    <title>Apotek Laras | Daftar</title>
          ...
          <div class="col-md-8 col-md-offset-2">
              <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title text-center"><b>Apotek Laras | Daftar Pelanggan</b><h3>
                </div>
                <div class="panel-body">
                    <form method="POST" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" rows="2" class="form-control" name="telepon" required>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    if (isset($_POST['daftar'])) {
                        ...
                        if ($cocok == 1){
                            ...
                            telepon_pelanggan, alamat_pelanggan) VALUES('$email', '$password', '$nama', '$telepon', '$alamat'
                            )");
